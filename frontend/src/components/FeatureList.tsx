...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <NavLink
      className={({ isActive }) =>
        `group flex flex-1 cursor-pointer select-none flex-col items-center justify-center rounded-xl bg-green-300/40 bg-clip-padding duration-150 hover:bg-green-400/60 active:scale-[.97] active:will-change-transform dark:bg-[#020804]/40 dark:hover:bg-[#5B876C]/40 ${
          isActive ? 'bg-green-400/80 dark:bg-[#2B6442]/40' : ''
        } ${expanded ? 'py-4 px-6' : 'py-2 px-3'}`
      }
      to={to}
      title={title}>
