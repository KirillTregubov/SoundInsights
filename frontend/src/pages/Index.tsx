...
const Index: React.FC = () => {
  return (
    <div className="mx-8 flex h-screen flex-col justify-center">
      <div className="relative my-16 mx-auto mb-44 flex max-w-3xl items-center gap-4 px-6">
        <img
        ...
        <div>
          ...
          <h2 className="mt-1 text-lg text-neutral-600 dark:text-neutral-400">
            This is a project that aims to help you discover new music and show
            interesting and meaningful information about Spotify data.
          </h2>
        </div>
        <svg
          ...
          fill="none"
          viewBox="0 0 301 426"
          className="absolute -left-36 top-10 h-52">
          <path
            fill="#191847"
            fillRule="evenodd"
        ...
        <svg
          ...
          fill="none"
          viewBox="0 0 360 441"
          className="absolute -right-32 top-6 h-56">
          <path
            fill="#D4A181"
            fillRule="evenodd"
